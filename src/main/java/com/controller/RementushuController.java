...
public class RementushuController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,RementushuEntity rementushu, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,RementushuEntity rementushu, HttpServletRequest request){
        EntityWrapper<RementushuEntity> ew = new EntityWrapper<RementushuEntity>();
    	PageUtils page = rementushuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, rementushu), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
