...
public class DiscussrementushuController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussrementushuEntity discussrementushu, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussrementushuEntity discussrementushu, HttpServletRequest request){
        EntityWrapper<DiscussrementushuEntity> ew = new EntityWrapper<DiscussrementushuEntity>();
    	PageUtils page = discussrementushuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussrementushu), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
